      ...
      <?php
        ...
        if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              <td><a href='editMember.php?id=$id&username=$username&password=$password&full_name=$full_name&sex=$seggs&birthday=$birthday&email=$email&phone=$phone&address=$address' class='btn btn-primary m-r-1em' name='edit'>Sửa</a>
